...
contract CreateSubscription is Script{
    ...
    function createSubscription(address vrfCoordinator,uint256 deployerKey) public returns(uint64) {
        ...
        vm.stopBroadcast();
        console.log("Created subscription ID #",subId,"on chain with ChainID:",block.chainid);
        return subId;
    }
...
contract AddConsumer is Script {
    ...
    function addressConsumerUsingConfig(address raffle)public{
        HelperConfig helperConfig = new HelperConfig();
    ...
    function run() external{
        ...
        addressConsumerUsingConfig(raffle);
    }
}
